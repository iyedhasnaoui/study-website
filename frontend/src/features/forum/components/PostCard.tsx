        ...
        <article
            ...
            <header className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-2">
                    {post.topicName && (
                        <span
                            className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-0.5 text-xs font-semibold text-slate-700 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300">
                            <span>{post.topicIcon ?? '💬'}</span>
            ...
            {!isEditing ? (
                <>
                  ...
                  #{tag}
                    ...
                    <footer
                        className="mt-5 flex flex-wrap items-center gap-3 text-xs text-slate-500 dark:text-zinc-400">
